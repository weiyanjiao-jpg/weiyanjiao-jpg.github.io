...
.project-list table tr{border-bottom: 1px solid #e7eaec;}
.project-list table tr td{display:block; width:100%;border-bottom:none;padding:5px;height: auto;}
.project-list table tr td input {width:100%;}
.project-list table tr td textarea	{width:100%;}
.project-list table tr td input[type=radio]{width:auto}
}
</style>
