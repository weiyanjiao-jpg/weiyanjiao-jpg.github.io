...
if($username&&$userid&&$rnd){
    ...
    $userpiclink = '<img id="pl-userpic" src="'.$userpic.'">';
  ...
  <div class="pl-post pl-post-reply">
    ...
    <div class="pl-tools">
       <ul>
         ...
         <li  class="username"><i class="iconfont">&#xe613;</i><input type="text" id="pl-username-reply" class="pl-key" size="15" placeholder="你的昵称" value="<?=$username?>" /></li>
       </ul>
    </div>
...
<!--       <div class="pl-area-userpic">
      ...
      <div class="pl-area-post">
        <div class="pl-post">
          <div class="pl-textarea"><textarea class="pl-post-word" id="pl-520am-f-saytext" placeholder="写下你想说的，开始我们的对话（请勿发表广告，否则您的评论将会被删除！）"></textarea>
          </div>
          <div class="pl-tools">
             <ul>
               ...
               <li  class="username"><i class="iconfont">&#xe613;</i><input type="text" id="pl-username" class="pl-key" size="15" placeholder="填写您的昵称" value="<?=$username?>" /></li>
             </ul>
          </div>
    ...
    <div class="pl-header"><em id="pl-joinnum">0</em>人参与，<em  id="pl-totalnum">0</em>条评论<span class="pl-userinfo" id="pl-userinfo"><?=$userlink?></span></div>
