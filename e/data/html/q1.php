...
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>价格</td><td bgcolor='ffffff'>
<input name="price" type="text" id="price" value="<?=$ecmsfirstpost==1?"":DoReqValue($mid,'price',stripSlashes($r[price]))?>" size="">
