...
{
?>
document.write("	<a href=\"/e/member/cp/\" title=\"会员中心\"><i class=\"fa fa-user-circle-o\"></i> 会员中心</a>&nbsp;&nbsp;	<a href=\"/e/member/doaction.php?enews=exit&ecmsfrom=9\" onclick=\"return confirm(\'提示：确认要退出?\');\" title=\"退出\"><i class=\"fa fa-sign-in\"></i> 退出登陆</a>");
<?php
	db_close();
	$empire=null;
}
...
{
?>
document.write("	<a href=\"/e/member/login/\" title=\"登录\" target=\"_blank\"><i class=\"fa fa-user-circle-o\"></i> 会员登陆</a>&nbsp;&nbsp;	<a href=\"/e/member/register/index.php?tobind=0&groupid=1\" title=\"注册\" target=\"_blank\"><i class=\"fa fa-plus-square\"></i> 注册会员</a>	");
<?php
}
?>